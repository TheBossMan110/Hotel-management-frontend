...
import { User, Mail, Phone, Shield, Save, Lock, Eye, EyeOff, CheckCircle } from 'lucide-react'
...
export default function AdminProfile() {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fadeIn">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-display font-light" style={{ color: '#F8F4EF' }}>Admin Profile</h1>
        <p className="text-sm mt-1" style={{ color: 'rgba(248,244,239,0.45)', fontFamily: 'DM Sans, sans-serif' }}>Manage your account information and security</p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-xs mt-1" style={{ color: 'rgba(248,244,239,0.3)', fontFamily: 'DM Sans, sans-serif' }}>Email cannot be changed</p>
              </div>
              <div>
